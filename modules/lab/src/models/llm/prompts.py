...
def create_prompt_from_optimized_part(part: dict) -> Prompt:
    """Create a Prompt object from an OPTIMIZED_PARTS entry.

    Args:
        part: Dictionary with keys: system, guideline, examples, output_format, input

    Returns:
        Prompt object
    """
    output_format = part.get("output_format", PROMPT_PARTS["output_format"]["base"])
    input_format = part.get("input", PROMPT_PARTS["input"])
    suffix_key = "cot" if "reasoning" in output_format else "base"
    suffix = output_format + "\n\n" + input_format

    return Prompt(
        system=part["system"],
        guideline=part["guideline"],
...
OPTIMIZED_PARTS = [
    # 0.772 MSE | seed 42 | depth 6 | width 5 | 27 muts | 5.5 hours
    {
        "system": "Evaluate text segments based on their ability to facilitate visualization, assessing how effectively a reader can form a mental image of the described content.",
        "guideline": "Rate the text's ability to evoke a visual image with the following scale:\n\n| Rating | Defining Feature | Disqualifying Feature |\n| --- | --- | --- |\n| 0 | No visual details | No description |\n| 1 | Simple object/person mentioned | No clear visual information |\n| 2 | Recognizable place or basic character described | Lacks distinctive visual details |\n| 3 | Basic scene or detailed face described | Limited context or unclear setting |\n| 4 | Full scene with descriptive details | Some ambiguity or missing elements |\n| 5 | Vivid, complete scene with clear, evocative details | Leaves no ambiguity, fully immersive |",
        "examples": '## Examples\nHere are examples demonstrating each rating level:\n\n<example_1>\n<text_segment>If not, please say so. The alternative is in the hands of the Crown. I am the Crown. The Crown may at any time confiscate property and banish malcontents and disturbers.</text_segment>\n{\n  "rating": 0\n}\n</example_1>\n\n<example_2>\n<text_segment>By this time the fresh new fool\'s cap made from yesterday\'s "Bee" would have been pinned on her head. "Quelle injustice! Quelle injustice!" This last apostrophe in a high, whining nasal voice, always procured Pupasse\'s elevation on the tall three-legged stool in the corner.</text_segment>\n{\n  "rating": 1\n}\n</example_2>\n\n<example_3>\n<text_segment>So he looked through the deep-blue luminous window once more, beyond the battles we know. From this he turned back shuddering. Again he saw the Professor smile with his lips, though whether at his own weakness, or whether with cynical mirth at the fate of the world, Rodriguez could not say.</text_segment>\n{\n  "rating": 2\n}\n</example_3>\n\n<example_4>\n<text_segment>When the meal had been arranged the prisoners saw that there was enough for four people instead of two; and the soldiers realized this also, for they turned puzzled looks first on the tables and then on the prisoners. Then they shook all their twin heads gravely and went away, locking the twin doors behind them.</text_segment>\n{\n  "rating": 3\n}\n</example_4>\n\n<example_5>\n<text_segment>The wonderful wheat-field was cut into a thousand squares and angles and lanes and curves. The big whirring combines passed one another, stopped and waited and turned out of the way, leaving everywhere little patches and cubes of standing wheat, that soon fell before the onslaught of the smaller combines.</text_segment>\n{\n  "rating": 4\n}\n</example_5>\n\n<example_6>\n<text_segment>Or one might go out into the harbour late upon a winter afternoon, and see it as a city of a million lights, rising like an incantation from the sea. Round about it was an unbroken ring of docks, with ferry-boats and tugs darting everywhere, and vessels which had come from every port in the world, emptying their cargoes into the huge maw of the Metropolis.</text_segment>\n{\n  "rating": 5\n}\n</example_6>',
        "output_format": '## Output Format\nProvide your answer as a JSON object. You must not answer with anything other than the JSON. Your message must end with the JSON closing curly bracket. You must follow this format:\n{\n  "rating": <integer 0-5>,\n  "confidence": <integer 0-5>,\n  "justification": "<one-sentence justification>"\n}',
        "input": "Rate the following text segment:\n\nFirst, read the text segment once to get an overall impression. Then, scan it for specific visual markers that may influence your rating. Finally, assign a rating based on your evaluation.\n\n<text_segment>{{TEXT_SEGMENT}}</text_segment>",
    },
    # 0.789 MSE | seed 42 | depth 5 | width 5 | 27 muts | 4.5 hours
    # {
    ...
    #     "examples": '## Examples\nHere are examples demonstrating each rating level:\n\n<example_1>\n<text_segment>If not, please say so. The alternative is in the hands of the Crown. I am the Crown. The Crown may at any time confiscate property and banish malcontents and disturbers.</text_segment>\n{\n  "rating": 0\n}\n</example_1>\n\n<example_2>\n<text_segment>By this time the fresh new fool\'s cap made from yesterday\'s "Bee" would have been pinned on her head. "Quelle injustice! Quelle injustice!" This last apostrophe in a high, whining nasal voice, always procured Pupasse\'s elevation on the tall three-legged stool in the corner.</text_segment>\n{\n  "rating": 1\n}\n</example_2>\n\n<example_3>\n<text_segment>So he looked through the deep-blue luminous window once more, beyond the battles we know. From this he turned back shuddering. Again he saw the Professor smile with his lips, though whether at his own weakness, or whether with cynical mirth at the fate of the world, Rodriguez could not say.</text_segment>\n{\n  "rating": 2\n}\n</example_3>\n\n<example_4>\n<text_segment>When the meal had been arranged the prisoners saw that there was enough for four people instead of two; and the soldiers realized this also, for they turned puzzled looks first on the tables and then on the prisoners. Then they shook all their twin heads gravely and went away, locking the twin doors behind them.</text_segment>\n{\n  "rating": 3\n}\n</example_4>\n\n<example_5>\n<text_segment>The wonderful wheat-field was cut into a thousand squares and angles and lanes and curves. The big whirring combines passed one another, stopped and waited and turned out of the way, leaving everywhere little patches and cubes of standing wheat, that soon fell before the onslaught of the smaller combines.</text_segment>\n{\n  "rating": 4\n}\n</example_5>\n\n<example_6>\n<text_segment>Or one might go out into the harbour late upon a winter afternoon, and see it as a city of a million lights, rising like an incantation from the sea. Round about it was an unbroken ring of docks, with ferry-boats and tugs darting everywhere, and vessels which had come from every port in the world, emptying their cargoes into the huge maw of the Metropolis.</text_segment>\n{\n  "rating": 5\n}\n</example_6>',
    #     "output_format": '## Output Format\nProvide your answer as a JSON object. You must not answer with anything other than the JSON. Your message must end with the JSON closing curly bracket. You must follow this format:\n{\n  "rating": <integer 0-5>,\n  "confidence": <integer 0-5>,\n  "justification": "<one-sentence justification>"\n}',
    #     "input": "Read the text segment once to get an overall impression. Then, scan it for specific visual markers that may influence your rating. After completing these steps, assign a rating to the text segment.\n\n<text_segment>{{TEXT_SEGMENT}}</text_segment>",
    # },
    # 0.787 MSE, 11 hours, depth 5, 5 rewrites
    # {
    #     "system": "You are an expert annotator tasked with rating text segments based on their visual descriptiveness. Your goal is to determine how well a reader can visualize the content described in the text.",
    #     "guideline": "Rate the text's ability to evoke a visual image with the following scale:\n\n| Rating | Defining Feature | Disqualifying Feature |\n| --- | --- | --- |\n| 0 | No visual details | No description |\n| 1 | Simple object/person mentioned | No clear mental image |\n| 2 | Recognizable place or basic character described | Lacks distinctive features |\n| 3 | Basic scene or detailed face described | Limited context or details |\n| 4 | Full scene with descriptive details | Some ambiguity or vagueness |\n| 5 | Vivid, complete scene with sensory details | Leaves no room for misinterpretation |",
    #     "examples": '## Examples\nHere are examples demonstrating each rating level:\n\n<example_1>\n<text_segment>If not, please say so. The alternative is in the hands of the Crown. I am the Crown. The Crown may at any time confiscate property and banish malcontents and disturbers.</text_segment>\n{\n  "rating": 0\n}\n</example_1>\n\n<example_2>\n<text_segment>By this time the fresh new fool\'s cap made from yesterday\'s "Bee" would have been pinned on her head. "Quelle injustice! Quelle injustice!" This last apostrophe in a high, whining nasal voice, always procured Pupasse\'s elevation on the tall three-legged stool in the corner.</text_segment>\n{\n  "rating": 1\n}\n</example_2>\n\n<example_3>\n<text_segment>So he looked through the deep-blue luminous window once more, beyond the battles we know. From this he turned back shuddering. Again he saw the Professor smile with his lips, though whether at his own weakness, or whether with cynical mirth at the fate of the world, Rodriguez could not say.</text_segment>\n{\n  "rating": 2\n}\n</example_3>\n\n<example_4>\n<text_segment>When the meal had been arranged the prisoners saw that there was enough for four people instead of two; and the soldiers realized this also, for they turned puzzled looks first on the tables and then on the prisoners. Then they shook all their twin heads gravely and went away, locking the twin doors behind them.</text_segment>\n{\n  "rating": 3\n}\n</example_4>\n\n<example_5>\n<text_segment>The wonderful wheat-field was cut into a thousand squares and angles and lanes and curves. The big whirring combines passed one another, stopped and waited and turned out of the way, leaving everywhere little patches and cubes of standing wheat, that soon fell before the onslaught of the smaller combines.</text_segment>\n{\n  "rating": 4\n}\n</example_5>\n\n<example_6>\n<text_segment>Or one might go out into the harbour late upon a winter afternoon, and see it as a city of a million lights, rising like an incantation from the sea. Round about it was an unbroken ring of docks, with ferry-boats and tugs darting everywhere, and vessels which had come from every port in the world, emptying their cargoes into the huge maw of the Metropolis.</text_segment>\n{\n  "rating": 5\n}\n</example_6>',
    #     "output_format": '## Output Format\nProvide your answer as a JSON object. You must not answer with anything other than the JSON. Your message must end with the JSON closing curly bracket. You must follow this format:\n{\n  "rating": <integer 0-5>,\n  "confidence": <integer 0-5>,\n  "justification": "<one-sentence justification>"\n}',
    #     "input": "Carefully scan the text as if you were studying it visually, examining its structure and content as you would when reading it for the first time.\n\n<text_segment>{{TEXT_SEGMENT}}</text_segment>",
    # },
    # 0.81 MSE
    # {
    #     "system": "You are an expert annotator tasked with rating text segments based on their visual descriptiveness. Your goal is to determine how well a reader can visualize the content described in the text.",
    #     "guideline": "Rate the text's ability to evoke a visual image, considering the following:\n\n* For abstract language, focus on the conceptual or emotional essence it conveys and how it translates into visual elements.\n* For figurative language, interpret it literally to assess its visualizability.\n* For technical jargon, evaluate its ability to evoke a visual image based on common knowledge or industry-specific visuals.\n* For minimalist prose, consider the implied visual context and details.\n\nScale:\n0 = not visualizable \n1 = simple object/person \n2 = recognizable place/basic character \n3 = basic scene/details \n4 = full scene with many details \n5 = vivid, complete scene with great detail",
    #     "examples": '## Examples\nHere are examples demonstrating each rating level:\n\n<example_1>\n<text_segment>If not, please say so. The alternative is in the hands of the Crown. I am the Crown. The Crown may at any time confiscate property and banish malcontents and disturbers.</text_segment>\n{\n  "rating": 0\n}\n</example_1>\n\n<example_2>\n<text_segment>By this time the fresh new fool\'s cap made from yesterday\'s "Bee" would have been pinned on her head. "Quelle injustice! Quelle injustice!" This last apostrophe in a high, whining nasal voice, always procured Pupasse\'s elevation on the tall three-legged stool in the corner.</text_segment>\n{\n  "rating": 1\n}\n</example_2>\n\n<example_3>\n<text_segment>So he looked through the deep-blue luminous window once more, beyond the battles we know. From this he turned back shuddering. Again he saw the Professor smile with his lips, though whether at his own weakness, or whether with cynical mirth at the fate of the world, Rodriguez could not say.</text_segment>\n{\n  "rating": 2\n}\n</example_3>\n\n<example_4>\n<text_segment>When the meal had been arranged the prisoners saw that there was enough for four people instead of two; and the soldiers realized this also, for they turned puzzled looks first on the tables and then on the prisoners. Then they shook all their twin heads gravely and went away, locking the twin doors behind them.</text_segment>\n{\n  "rating": 3\n}\n</example_4>\n\n<example_5>\n<text_segment>The wonderful wheat-field was cut into a thousand squares and angles and lanes and curves. The big whirring combines passed one another, stopped and waited and turned out of the way, leaving everywhere little patches and cubes of standing wheat, that soon fell before the onslaught of the smaller combines.</text_segment>\n{\n  "rating": 4\n}\n</example_5>\n\n<example_6>\n<text_segment>Or one might go out into the harbour late upon a winter afternoon, and see it as a city of a million lights, rising like an incantation from the sea. Round about it was an unbroken ring of docks, with ferry-boats and tugs darting everywhere, and vessels which had come from every port in the world, emptying their cargoes into the huge maw of the Metropolis.</text_segment>\n{\n  "rating": 5\n}\n</example_6>',
    #     "output_format": '## Output Format\nProvide your answer as a JSON object. You must not answer with anything other than the JSON. Your message must end with the JSON closing curly bracket. You must follow this format:\n{\n  "rating": <integer 0-5>,\n  "confidence": <integer 0-5>,\n  "justification": "<one-sentence justification>"\n}',
    #     "input": "## Input\nRate the following text segment:\n\n<text_segment>{{TEXT_SEGMENT}}</text_segment>",
    # },
    ...
    #     "guideline": "On a scale of 0-5, rate how well this text allows a reader to visualize the scene, objects, or characters described: 0=not visualizable, 1=simple object/person, 2=recognizable place/basic character, 3=basic scene/detailed face, 4=full scene with details, 5=vivid complete scene.",
    #     "examples": '## Examples\nHere are examples demonstrating each rating level:\n\n<example_1>\n<text_segment>If not, please say so. The alternative is in the hands of the Crown. I am the Crown. The Crown may at any time confiscate property and banish malcontents and disturbers.</text_segment>\n{\n  "rating": 0\n}\n</example_1>\n\n<example_2>\n<text_segment>By this time the fresh new fool\'s cap made from yesterday\'s "Bee" would have been pinned on her head. "Quelle injustice! Quelle injustice!" This last apostrophe in a high, whining nasal voice, always procured Pupasse\'s elevation on the tall three-legged stool in the corner.</text_segment>\n{\n  "rating": 1\n}\n</example_2>\n\n<example_3>\n<text_segment>So he looked through the deep-blue luminous window once more, beyond the battles we know. From this he turned back shuddering. Again he saw the Professor smile with his lips, though whether at his own weakness, or whether with cynical mirth at the fate of the world, Rodriguez could not say.</text_segment>\n{\n  "rating": 2\n}\n</example_3>\n\n<example_4>\n<text_segment>When the meal had been arranged the prisoners saw that there was enough for four people instead of two; and the soldiers realized this also, for they turned puzzled looks first on the tables and then on the prisoners. Then they shook all their twin heads gravely and went away, locking the twin doors behind them.</text_segment>\n{\n  "rating": 3\n}\n</example_4>\n\n<example_5>\n<text_segment>The wonderful wheat-field was cut into a thousand squares and angles and lanes and curves. The big whirring combines passed one another, stopped and waited and turned out of the way, leaving everywhere little patches and cubes of standing wheat, that soon fell before the onslaught of the smaller combines.</text_segment>\n{\n  "rating": 4\n}\n</example_5>\n\n<example_6>\n<text_segment>Or one might go out into the harbour late upon a winter afternoon, and see it as a city of a million lights, rising like an incantation from the sea. Round about it was an unbroken ring of docks, with ferry-boats and tugs darting everywhere, and vessels which had come from every port in the world, emptying their cargoes into the huge maw of the Metropolis.</text_segment>\n{\n  "rating": 5\n}\n</example_6>',
    #     "output_format": '## Output Format\nProvide your answer as a JSON object, including a confidence score that reflects your certainty in the rating. Your response should be a JSON object with an integer rating between 0 and 5, and a confidence level between 0 and 100. Follow this format:\n{\n  "rating": <integer 0-5>,\n  "confidence": <integer 0-100>\n}',
    #     "input": "## Input\nRate the following text segment:\n\n<text_segment>{{TEXT_SEGMENT}}</text_segment>",
    # },
    # 1.091 ARMSE
    # {
...
OPTIMIZED_PROMPTS: list[Prompt] = [
    create_prompt_from_optimized_part(part) for part in OPTIMIZED_PARTS
]
