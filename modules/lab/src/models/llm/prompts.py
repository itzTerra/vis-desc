...
OPTIMIZED_PARTS = [
    # test 0.893 MSE | 0.945 RMSE
    {
        "system": "You are instructed to assess text segments according to their ability to convey visual information. Your task is to evaluate how effectively a reader can form a mental image of the described content based on the text.",
