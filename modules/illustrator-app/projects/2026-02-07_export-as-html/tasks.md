...
- [x] Update help copy or guidance text to mention the HTML export.
- [x] Manual verification: export with and without images, lazy loading behavior, modal image preview size, offline usage.
